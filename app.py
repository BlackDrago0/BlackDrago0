...
async def main(page: ft.Page, button=None) -> None:
    page.title = "Pepe Clicker"
    page.theme_mode = ft.ThemeMode.DARK
    page.bgcolor = "#141221"
    page.vertical_alignment = ft.MainAxisAlignment.CENTER
    page.horizontal_alignment = ft.CrossAxisAlignment.CENTER
    page.fonts = {"OrbitronVariableFontwght": "fonts/OrbitronVariableFontwght.ttf"}
    page.theme = ft.Theme(font_family="OrbitronVariableFontwght")
